    ...
    Double_t lumi = 1)
{
    ...
    TString infilename = inputDirectory + "/ntuples/2018/";
    TString infilename_friend = infilename;
    infilename_friend = infilename_friend.ReplaceAll("ntuples", "friends/crosssection");
    TString bkgvdirname;
    if (doElectron)
        bkgvdirname = inputDirectory + "/ntuples/2018/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_RunIISummer20UL18NanoAODv9-106X/ee/";
    if (!doElectron)
        bkgvdirname = inputDirectory + "/ntuples/2018/TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8_RunIISummer20UL18NanoAODv9-106X/mm/";
    ...
    if(inputType == 0) {
        sigIsData = true;
        if(!doElectron) {
            sig_chain->Add(infilename + "SingleMuon_Run2018A-UL2018/mm/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "SingleMuon_Run2018A-UL2018/mm/*.root/ntuple");
            sig_chain->Add(infilename + "SingleMuon_Run2018B-UL2018/mm/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "SingleMuon_Run2018B-UL2018/mm/*.root/ntuple");
            sig_chain->Add(infilename + "SingleMuon_Run2018C-UL2018/mm/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "SingleMuon_Run2018C-UL2018/mm/*.root/ntuple");
            sig_chain->Add(infilename + "SingleMuon_Run2018D-UL2018/mm/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "SingleMuon_Run2018D-UL2018/mm/*.root/ntuple");
        }
        if(doElectron) {
            sig_chain->Add(infilename + "EGamma_Run2018A-UL2018/ee/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "EGamma_Run2018A-UL2018/ee/*.root/ntuple");
            sig_chain->Add(infilename + "EGamma_Run2018B-UL2018/ee/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "EGamma_Run_2018B-UL2018/ee/*.root/ntuple");
            sig_chain->Add(infilename + "EGamma_Run2018C-UL2018/ee/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "EGamma_Run2018C-UL2018/ee/*.root/ntuple");
            sig_chain->Add(infilename + "EGamma_Run2018D-UL2018/ee/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "EGamma_Run2018D-UL2018/ee/*.root/ntuple");
        }
    }
    //Z->ll SIMULATION SAMPLE
    if (inputType == 1) {
        if(doElectron) {
            sig_chain->Add(infilename + "DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/ee/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/ee/*.root/ntuple");
        } else {
            sig_chain->Add(infilename + "DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/mm/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "DYJetsToLL_M-50_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/mm/*.root/ntuple");
        }    
    }
    // W SIMULATION SAMPLE
    if (inputType > 1) {
        if (!doElectron) {
            sig_chain->Add(infilename + "WJetsToLNu_0J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/mmet/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "WJetsToLNu_0J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/mmet/*.root/ntuple");
            sig_chain->Add(infilename + "WJetsToLNu_1J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/mmet/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "WJetsToLNu_1J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/mmet/*.root/ntuple");
            sig_chain->Add(infilename + "WJetsToLNu_2J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/mmet/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "WJetsToLNu_2J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/mmet/*.root/ntuple");
        }
        if (doElectron) {
            sig_chain->Add(infilename + "WJetsToLNu_0J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/emet/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "WJetsToLNu_0J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/emet/*.root/ntuple");
            sig_chain->Add(infilename + "WJetsToLNu_1J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/emet/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "WJetsToLNu_1J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/emet/*.root/ntuple");
            sig_chain->Add(infilename + "WJetsToLNu_2J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/emet/*.root/ntuple");
            sig_friend_chain->Add(infilename_friend + "WJetsToLNu_2J_TuneCP5_13TeV-amcatnloFXFX-pythia8_RunIISummer20UL18NanoAODv9-106X/emet/*.root/ntuple");
        }
    }
    ...
    Float_t lep1_pt, lep1_eta, lep1_phi, lep1_mass;
    Float_t lep2_pt, lep2_eta, lep2_phi, lep2_mass;
    Float_t scale1fb;
    Float_t met, metPhi;
    Int_t q1, q2;
    Float_t scale1fbSumW, genWeight;
    Float_t eCorr_1, eCorr_2;
    Double_t pt_rc_1, pt_rc_2;
    ...
    for (UInt_t ifile = 0; ifile < fnamev.size(); ifile++) {
        ...
        intree->SetBranchAddress("pt_1", &lep1_pt); // pt of tag lepton
        ...
        if (doElectron) {
            intree->SetBranchAddress("eCorr_1", &eCorr_1); // pt correction factor (already applied to pt_1 in ntuple)
        } else {
            intree->SetBranchAddress("pt_rc_1", &pt_rc_1); //rochester corrected pt for tag lepton
        }

        if (inputType<2) { // Z specific variables
            intree->SetBranchAddress("q_2", &q2); // charge of probe lepton
            intree->SetBranchAddress("pt_2", &lep2_pt); // pt of probe lepton
            ...
            if (doElectron) {
                intree->SetBranchAddress("eCorr_2", &eCorr_2); // pt correction factor (already applied to pt_2 in ntuple)
            } else {
                intree->SetBranchAddress("pt_rc_2", &pt_rc_2); //rochester corrected pt for probe lepton
            }
        }
        ...
        for (Int_t ientry = 0; ientry < intree->GetEntries(); ientry += iterator) {
            ...
            if (inputType < 2 ) { //Z events
                if (doElectron) {
                    ...
                    mu1.SetPtEtaPhiM(pt_rc_1, lep1_eta, lep1_phi, lep1_mass);
                    mu2.SetPtEtaPhiM(pt_rc_2, lep2_eta, lep2_phi, lep2_mass);
                }
            ...
            if (inputType < 2) { //Z Events
                if (doElectron) {
                    vLepRaw1.Set((lep1_pt/eCorr_1) * cos(lep1_phi), (lep1_pt/eCorr_1) * sin(lep1_phi));
                    vLepRaw2.Set((lep2_pt/eCorr_2) * cos(lep2_phi), (lep2_pt/eCorr_2) * sin(lep2_phi));

                    vLepCor1.Set((lep1_pt) * cos(lep1_phi), (lep1_pt) * sin(lep1_phi));
                    vLepCor2.Set((lep2_pt) * cos(lep2_phi), (lep2_pt) * sin(lep2_phi));
                } else {
                    vLepRaw1.Set((lep1_pt) * cos(lep1_phi), (lep1_pt) * sin(lep1_phi));
                    vLepRaw2.Set((lep2_pt) * cos(lep2_phi), (lep2_pt) * sin(lep2_phi));

                    vLepCor1.Set((pt_rc_1) * cos(lep1_phi), (pt_rc_1) * sin(lep1_phi));
                    vLepCor2.Set((pt_rc_2) * cos(lep2_phi), (pt_rc_2) * sin(lep2_phi));
                }
