...
def parse_args():
    ...
    parser.add_argument('-I', '--inpath', default='/ceph/moh/CROWN_samples/Run3V02/ntuples/2022/*/mm*/*.root', help='path to input samples')
...
def run(input_dict):
    ...
    if args.test:
        ...
        outdir = infile.replace("/ntuples/", "/friends/met_corr"+syst_postfix+"/")
    ...
    if not ("DYtoLL" in process or "WtoLNu" in process):
        ...
        if not os.path.exists(outfile) or args.overwrite:
            rdf.Snapshot("ntuple", outfile, original_cols + [
    ...
    if not os.path.exists(outfile) or args.overwrite:
        rdf_tosave.Snapshot("ntuple", outfile, original_cols + [
            "uP1"+corrected+syst_postfix, "uP2"+corrected+syst_postfix, met+corrected+syst_postfix, met+"phi"+corrected+syst_postfix,
            "pfuP1"+corrected+syst_postfix, "pfuP2"+corrected+syst_postfix, "pfmet"+corrected+syst_postfix, "pfmetphi"+corrected+syst_postfix
        ])
...
if __name__=='__main__':
    ...
    ws_dicts = [
        ...
        # {
        #     "data_mm":  "/home/moh/CROWN_working/Z_early_Run3/corrections/recoil/KitRecoilCorrections/Run3V02_outputs/met_uncorrected_data_CB_muon_sigAndBck/", 
        #     "Zmm":      "/home/moh/CROWN_working/Z_early_Run3/corrections/recoil/KitRecoilCorrections/Run3V02_outputs/met_uncorrected_ZllMC_CB_muon_sigOnly/",
        #     "Wmneg":    "/home/moh/CROWN_working/Z_early_Run3/corrections/recoil/KitRecoilCorrections/Run3V02_outputs/met_uncorrected_WnegMC_CB_muon_sigOnly/",
        #     "Wmpos":    "/home/moh/CROWN_working/Z_early_Run3/corrections/recoil/KitRecoilCorrections/Run3V02_outputs/met_uncorrected_WposMC_CB_muon_sigOnly/",

        #     "data_mm_pf":  "/home/moh/CROWN_working/Z_early_Run3/corrections/recoil/KitRecoilCorrections/Run3V02_outputs/pfmet_uncorrected_data_CB_muon_sigAndBck/", 
        #     "Zmm_pf":      "/home/moh/CROWN_working/Z_early_Run3/corrections/recoil/KitRecoilCorrections/Run3V02_outputs/pfmet_uncorrected_ZllMC_CB_muon_sigOnly/",
        #     "Wmneg_pf":    "/home/moh/CROWN_working/Z_early_Run3/corrections/recoil/KitRecoilCorrections/Run3V02_outputs/pfmet_uncorrected_WnegMC_CB_muon_sigOnly/",
        #     "Wmpos_pf":    "/home/moh/CROWN_working/Z_early_Run3/corrections/recoil/KitRecoilCorrections/Run3V02_outputs/pfmet_uncorrected_WposMC_CB_muon_sigOnly/",
        # },
