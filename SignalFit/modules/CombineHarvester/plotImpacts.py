...
def plotImpacts(ifilename, ofilename, blind=True):
    ...
    plot.ModTDRStyle(l=0.4, b=0.10, width=(900 if checkBoxes else 700), height=600, r = 0.07)
    ...
    for page in range(n):
        ...
        h_pulls = ROOT.TH2F("pulls", "pulls", 6, -3.9, 3.9, n_params, 0, n_params)
        ...
        plot.Set(h_impacts.GetXaxis(), LabelSize=0.03, TitleSize=0.02, TitleOffset=1.5, Ndivisions=505, Title=
            '#Delta#hat{%s}' % (POI))
