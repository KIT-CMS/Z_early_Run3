...
if doInclusive:
    ...
    for fit_variable_w in w_fit_vars:
        ...
        for idx in range(nscans):
            ...
            for syst_name, systs in syst_groups.items():
                ...
                print("\n\n")
                print(FormatTable(impacts, caption=f"Systematic uncertainties in percentage {fit_var_short} wbin{idx}_syst{syst_name}", label = f"tab:impacts", precision=2, simple=True))
                print("\n")
                print(FormatTable(impacts, caption=f"Systematic uncertainties in percentage {fit_var_short} wbin{idx}_syst{syst_name}", label = f"tab:impacts", precision=2))
    ...
    if not doAsimov:
        ...
        print("\n\n")
        print(FormatTable(impacts, caption=f"Systematic uncertainties in percentage pfmet_pfmt", label = f"tab:impacts", precision=2, simple=True))
        print("\n")
        print(FormatTable(impacts, caption=f"Systematic uncertainties in percentage pfmet_pfmt", label = f"tab:impacts", precision=2))
