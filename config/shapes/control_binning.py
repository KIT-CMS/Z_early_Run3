...
uniformBinningDict = {
    ...
    'm_toFit_up': [60,120,30],
    'm_toFit_dn': [60,120,30],
}
...
def renamingVariable(var, base, channel):
    ...
    if "m_toFit" in var:
        base = "m_vis_corr"
    if "m_toFit_dn" in var:
        base = "m_vis_corr_dn"
    if "m_toFit_up" in var:
        base = "m_vis_corr_up"
